  ...
  return (
    <div style={{
          ...
          <form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 w-1/2">
            <div className="mb-6">
              <label htmlFor="firstName" className="text-sm block font-semibold pb-2">
                  First Name
                </label>
                <TextBox
            ...
            <div className="mb-6">
             <label htmlFor="lastName" className="text-sm block font-semibold  pb-2">
               Last Name
            </label>
             <TextBox
              className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
            ...
            <div className="mb-6">
            <label htmlFor="username" className="text-sm block font-semibold pb-2">
               Username
             </label>
             <TextBox
             className={"shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"}
           ...
           <div className="mb-6">
             <label htmlFor="password" className="text-sm block font-semibold pb-2">
               Password
             </label>
             <TextBox
             className={"shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"}
            ...
            <div className="flex flex-wrap sm:flex-no-wrap justify-center sm:items-center sm:justify-between items-stretch">
              <button 
                ...
                className="bg-teal-500 hover:bg-teal-700 text-white font-bold py-2 px-8 rounded focus:outline-none focus:shadow-outline w-full" type="button"
              >
                Sign Up
              </button>
              <button
              ...
              className="w-full font-bold py-2 px-2 rounded " type="button">
